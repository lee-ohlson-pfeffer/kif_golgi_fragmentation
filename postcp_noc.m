...
large_distance_thresh = 5;
object_thresh_percent = .05;
object_thresh_thresh = 125;
...
for for1 = 1:numel(file_name)
    ...
    gol_img = Image;
    load([DirOut1 file_name{for1}(1:end-7) 'GOL_MGL.mat'])
    gol_msk = Image;
...
cel_stat = [cel_stat nuc_labl nuc_area nuc_comp nuc_soli nuc_form ...
    ...
    cel_mgl_maxA mgl_intI mgl_maxI mgl_avgI cgl_area ...
    cgl_avgI cgl_intI cgl_comp cgl_soli cgl_form cgl_mrad cgl_vrad cgl_miax ...
    cgl_maax cgl_orie cgl_mifd cgl_mafd cgl_mdis cgl_vdis ...
